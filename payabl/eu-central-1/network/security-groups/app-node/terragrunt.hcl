/// security-groups/app-node/terragrunt.hcl
include "root" {
...
dependency "private-alb-sg" {
  config_path = "${get_terragrunt_dir()}/../private-alb"
}
    ...
    ingress_with_cidr_blocks = [
      {
        ...
        source_security_group_id = dependency.private-alb-sg.outputs.security_group_id
      },
    ]
